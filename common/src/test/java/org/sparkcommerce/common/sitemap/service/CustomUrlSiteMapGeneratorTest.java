...
import org.sparkcommerce.common.sitemap.domain.CustomUrlSiteMapGeneratorConfigurationImpl;
import org.sparkcommerce.common.sitemap.domain.SiteMapUrlEntry;
import org.sparkcommerce.common.sitemap.domain.SiteMapUrlEntryImpl;
...
public class CustomUrlSiteMapGeneratorTest extends SiteMapGeneratorTest {
    ...
    public void testCustomUrlSiteMapGenerator() throws SiteMapException, IOException {
        ...
        compareFiles(file1, "src/test/resources/org/sparkcommerce/sitemap/custom/sitemap_index.xml");
        compareFiles(file2, "src/test/resources/org/sparkcommerce/sitemap/custom/sitemap1.xml");
        compareFiles(file3, "src/test/resources/org/sparkcommerce/sitemap/custom/sitemap2.xml");
