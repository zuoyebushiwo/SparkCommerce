 ...
 * #L%
 */
/* Utility methods provided by Spark Commerce */
var SC = (function($) {
    ...
    var redirectUrlDiv = "blc-redirect-url",
        ...
        servletContext = "//SC-SERVLET-CONTEXT",
        siteBaseUrl = "//SC-SITE-BASEURL";
    ...
    function get(options, callback) {
        ...
        options.type = 'GET';
        return SC.ajax(options, callback);
    }
    ...
    addPreAjaxCallbackHandler(function($data) {
        return SC.redirectIfNecessary($data);
    });
