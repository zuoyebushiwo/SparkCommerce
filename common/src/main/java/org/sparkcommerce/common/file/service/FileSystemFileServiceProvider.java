...
/**
 * Default implementation of FileServiceProvider that uses the local file system to store files created by Spark
 * components.
 * 
...
public class FileSystemFileServiceProvider implements FileServiceProvider {
     ...
     * is done largely for backward compatibility with similar functionality in SC 3.0.0.
     * 
