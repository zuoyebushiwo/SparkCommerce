...
import org.sparkcommerce.common.file.FileServiceException;
 ...
 * 
 * For example usage, see {@link SiteMapGenerator}.  The Spark CMS module also uses this component to load, store, and 
...
public class SparkFileServiceImpl implements SparkFileService {
    
    private static final Log LOG = LogFactory.getLog(SparkFileServiceImpl.class);
