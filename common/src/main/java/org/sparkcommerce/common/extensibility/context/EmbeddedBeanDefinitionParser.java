...
import org.sparkcommerce.common.extensibility.context.merge.ImportProcessor;
import org.sparkcommerce.common.extensibility.context.merge.exceptions.MergeException;
 ...
 * is utilized by {@link org.sparkcommerce.common.web.extensibility.MergeContextLoaderListener}. However, in some circumstances,
 * it may be desirable to load all the Spark Commerce Spring beans into a declaring application context without the
 * aid of MergeContextLoaderListener. A sample use case for this would be a system that needs to run Spark Commerce
 ...
 * <beans xmlns="http://www.springframework.org/schema/beans"
        ...
        xmlns:embedded="http://schema.sparkcommerce.org/embedded"
        xsi:schemaLocation="http://www.springframework.org/schema/beans
                http://www.springframework.org/schema/beans/spring-beans-3.2.xsd
                http://www.springframework.org/schema/context
                http://www.springframework.org/schema/context/spring-context-3.2.xsd
                http://schema.sparkcommerce.org/embedded
                http://schema.sparkcommerce.org/embedded/embedded-3.1.xsd">
 * }
 *
 * Note the introduction of the new embedded namespace. Using this syntax, Spark Commerce merge functionality can be
...
public class EmbeddedBeanDefinitionParser extends AbstractBeanDefinitionParser {
    ...
    protected AbstractBeanDefinition parseInternal(Element element, ParserContext parserContext) {
        try {
            String[] sparkConfigLocations = StandardConfigLocations.retrieveAll(StandardConfigLocations.APPCONTEXTTYPE);

            ArrayList<ResourceInputStream> sources = new ArrayList<ResourceInputStream>(20);
            for (String location : sparkConfigLocations) {
