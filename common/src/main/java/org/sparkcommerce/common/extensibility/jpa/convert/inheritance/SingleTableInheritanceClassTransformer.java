...
import org.sparkcommerce.common.extensibility.jpa.copy.AbstractClassTransformer;
 ...
 *
 */
public class SingleTableInheritanceClassTransformer extends AbstractClassTransformer implements SparkClassTransformer {
    
    public static final String SINGLE_TABLE_ENTITIES = "spark.ejb.entities.override_single_table";
    ...
    public void compileJPAProperties(Properties props, Object key) throws Exception {
        if (((String) key).equals(SINGLE_TABLE_ENTITIES)) {
            ...
            for (String clazz : classes) {
                ...
                String discriminatorName = props.getProperty("spark.ejb."+keyName+".discriminator.name");
                if (discriminatorName != null) {
                    info.setDiscriminatorName(discriminatorName);
                    String type = props.getProperty("spark.ejb."+keyName+".discriminator.type");
                    if (type != null) {
                        info.setDiscriminatorType(DiscriminatorType.valueOf(type));
                    }
                    String length = props.getProperty("spark.ejb."+keyName+".discriminator.length");
                    if (length != null) {
