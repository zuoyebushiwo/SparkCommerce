...
import org.sparkcommerce.common.resource.service.ResourceBundlingService;
import org.sparkcommerce.common.resource.service.ResourceMinificationService;
...
import org.sparkcommerce.common.web.SparkThemeResolver;
...
public class SparkResourceHttpRequestHandler extends ResourceHttpRequestHandler {
    private static final Log LOG = LogFactory.getLog(SparkResourceHttpRequestHandler.class);
    ...
    protected SparkSandBoxResolver sbResolver;
    ...
    protected void establishThinRequestContext() {
        SparkRequestContext oldBrc = SparkRequestContext.getSparkRequestContext();
        if (oldBrc == null || oldBrc.getSite() == null || oldBrc.getTheme() == null) {
            ...
            // For example, resolving a sandbox requires the current user to have the SC_ADMIN_USER in his Authentication.
            ...
            SparkRequestContext newBrc = new SparkRequestContext();
            if (!isGlobalAdmin(req)) {
                ...
                SparkRequestContext.setSparkRequestContext(newBrc);
