...
public class SparkSandBoxResolverImpl implements SparkSandBoxResolver  {
    private final Log LOG = LogFactory.getLog(SparkSandBoxResolverImpl.class);
        ...
        if (!sandBoxPreviewEnabled) {
            ...
            if (sandboxId != null) {
                if (previousSandBoxId != null && !previousSandBoxId.equals(sandboxId)) {
                    request.setAttribute(SparkRequestProcessor.REPROCESS_PARAM_NAME, true, WebRequest.SCOPE_REQUEST);
                }
