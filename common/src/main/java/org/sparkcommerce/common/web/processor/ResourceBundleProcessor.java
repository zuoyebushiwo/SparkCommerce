...
import org.sparkcommerce.common.web.util.ProcessorUtils;
...
public class ResourceBundleProcessor extends AbstractElementProcessor {
    ...
    protected boolean getBundleEnabled() {
        ...
        return SCSystemProperty.resolveBooleanSystemProperty("bundle.enabled") && (brc.getSandBox() == null || brc.getAdmin());
    }
    ...
    protected ProcessorResult processElement(Arguments arguments, Element element) {
        ...
        if (getBundleEnabled()) {
            ...
            if (StringUtils.isBlank(versionedBundle)) {
                SparkResourceHttpRequestHandler reqHandler = getRequestHandler(name, arguments);
                try {
    ...
    protected SparkResourceHttpRequestHandler getRequestHandler(String name, Arguments arguments) {
        SparkResourceHttpRequestHandler handler = null;
        if (name.endsWith(".js")) {
