...
import org.sparkcommerce.common.web.resource.AbstractGeneratedResourceHandler;
import org.sparkcommerce.common.web.resource.SparkResourceHttpRequestHandler;
import org.sparkcommerce.common.web.resource.ResourceRequestExtensionHandler;
import org.sparkcommerce.common.web.resource.ResourceRequestExtensionManager;
...
public class ResourceBundlingServiceImpl implements ResourceBundlingService {
    ...
    // ex: "global12345.js" ==> [Resource("/js/SC.js"), Resource("/js/blc-admin.js")]
    ...
    protected SparkFileService fileService;
    ...
    public synchronized String registerBundle(String bundleName, List<String> files, 
            SparkResourceHttpRequestHandler handler) throws IOException {
