...
import org.sparkcommerce.common.sandbox.domain.SandBoxManagement;
import org.sparkcommerce.common.sandbox.domain.SandBoxManagementImpl;
...
public class SandBoxDaoImpl implements SandBoxDao {
    ...
    public SandBox retrieve(Long id) {
        ...
        //(i.e. org.hibernate.HibernateException: Found two representations of same collection: org.sparkcommerce.core.catalog.domain.ProductImpl.additionalSkus
    ...
    public Map<Long, String> retrieveAuthorNamesForSandBoxes(Set<Long> sandBoxIds) {
        Query query = sandBoxEntityManager.createQuery(
                ...
                "FROM org.sparkcommerce.common.sandbox.domain.SandBoxManagementImpl sb, " +
                    "org.sparkcommerce.openadmin.server.security.domain.AdminUserImpl au " +
