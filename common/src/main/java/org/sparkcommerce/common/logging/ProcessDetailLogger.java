 ...
 * </layout>
 * </appender>
 * <logger name="com.sparkcommerce.enterprise.workflow.process.detail" additivity="false">
 * <level value="debug"/>
 ...
 * }
 *
 * If you duplicated the sample configuration exactly, you would provide the logger name "com.sparkcommerce.enterprise.workflow.process.detail"
        ...
        if (!disableAllProcessDetailLogging) {
            ...
            if (!ignoreNoProcessDetailLoggerConfiguration && !processDetailLog.isDebugEnabled()) {
                LOGGER.support("The system has detected that a ProcessDetailLogger instance was requested without " +
                        ...
                        "</layout>\n" +
                        "</appender>\n" +
                        "<logger name=\"com.sparkcommerce.enterprise.workflow.process.detail\" " +
                        "additivity=\"false\">\n" +
                        "<level value=\"debug\"/>\n" +
                        "<appender-ref ref=\"rollingDailyEnterpriseWorkflow\"/>\n" +
                        "</logger>\n" +
