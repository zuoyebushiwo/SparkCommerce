 ...
 * %%
 */
package org.sparkcommerce.common.currency.util;
 ...
 * @see {@link SparkCurrency}
 */
public class SparkCurrencyUtils {
    ...
    public static Money getMoney(BigDecimal amount, SparkCurrency currency) {
        if (amount == null) {
            return null;
        }
    ...
    public static Money getMoney(SparkCurrency currency) {
        if (currency != null) {
    ...
    public static Currency getCurrency(SparkCurrency currency) {
    ...
    public static Money getUnitAmount(Money difference) {
        Currency currency = SparkCurrencyUtils.getCurrency(difference);
     ...
     * @return
     */
    public static Money getUnitAmount(SparkCurrency blCurrency) {
