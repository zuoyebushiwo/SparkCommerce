...
import org.sparkcommerce.common.extensibility.context.MergeFileSystemAndClassPathXMLApplicationContext;
import org.sparkcommerce.common.extensibility.context.StandardConfigLocations;
import org.sparkcommerce.common.extensibility.jpa.ConfigurationOnlyState;
        ...
        try {
            ...
            if (refineFileNames) {
                ...
                for (File file : sqlFiles) {
                    ...
                    String[] starters = {"org.hibernate.dialect.", "org.sparkcommerce.profile.util.sql."};
