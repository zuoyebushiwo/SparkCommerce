 ...
 */
@Entity
@Table(name = "SC_EMAIL_TRACKING_CLICKS")
public class EmailTrackingClicksImpl implements EmailTrackingClicks {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.common.email.domain.EmailTrackingClicksImpl")
        }
    )
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#getId()
     */
    @Override
    public Long getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#setId(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#getDateClicked()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#setDateClicked(java.util.Date)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#getDestinationUri()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#setDestinationUri(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#getQueryString()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#setQueryString(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#getEmailTracking()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.common.email.domain.EmailTrackingClicks#setEmailTracking(org.sparkcommerce.common.email.domain.EmailTrackingImpl)
     */
    @Override
