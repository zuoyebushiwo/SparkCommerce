...
public @interface AdminPresentation {
     ...
     *
     * If a security level is specified, it is registered with org.sparkcommerce.openadmin.client.security.SecurityManager
     ...
     * you must specify the fully qualified class name of the Spark Enumeration here.
     * 
     * @return Spark enumeration class name
     */
    String sparkEnumeration() default "";
