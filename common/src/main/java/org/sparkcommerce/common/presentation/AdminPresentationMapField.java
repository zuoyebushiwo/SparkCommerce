...
public @interface AdminPresentationMapField {
    ...
    /**
     * <p>Optional - if the map field value contains searchable information and should be included in Spark
     * search engine indexing and searching. If set, the map value class must implement the <tt>Searchable</tt> interface.
     * Note, support for indexing and searching this field must be explicitly added to the Spark search service
     * as well.</p>
     *
     * @return Whether or not this field is searchable with the Spark search engine
     */
