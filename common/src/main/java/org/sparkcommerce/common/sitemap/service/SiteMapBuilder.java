...
import org.sparkcommerce.common.sitemap.wrapper.SiteMapIndexWrapper;
import org.sparkcommerce.common.sitemap.wrapper.SiteMapURLSetWrapper;
import org.sparkcommerce.common.sitemap.wrapper.SiteMapURLWrapper;
import org.sparkcommerce.common.sitemap.wrapper.SiteMapWrapper;
...
public class SiteMapBuilder {
    ...
    protected void persistIndexedSiteMap() {
        ...
        for (String fileName : indexedFileNames) {
            ...
            String fileLoc = null;
            if (gzipSiteMapFiles) {
                fileLoc = SparkFileUtils.appendUnixPaths(baseUrl, fileName + ".gz");
            } else {
                fileLoc = SparkFileUtils.appendUnixPaths(baseUrl, fileName);
            }
