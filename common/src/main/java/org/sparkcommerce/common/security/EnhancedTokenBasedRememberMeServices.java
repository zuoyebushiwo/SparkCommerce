...
import org.sparkcommerce.common.security.util.CookieUtils;
 ...
 * to cookie values that are generated by Spark Commerce. Since the default implementation
 * provided by Spring Security does not provide this additional functionality, we override
 * here to use the CookieUtils in Spark that will include the httpOnly value.
 * 
