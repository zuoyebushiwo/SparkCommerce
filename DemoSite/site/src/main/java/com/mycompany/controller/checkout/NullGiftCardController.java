...
import org.sparkcommerce.core.web.checkout.model.GiftCardInfoForm;
...
import org.sparkcommerce.core.web.controller.checkout.AbstractCheckoutController;
 ...
 * http://www.sparkcommerce.com/contact
 *
...
public class NullGiftCardController extends AbstractCheckoutController {
    ...
    public String applyGiftCard(HttpServletRequest request, HttpServletResponse response, Model model,
        ...
        if (!result.hasErrors()) {
            result.reject("giftCardNumber", "The Gift Card module is not enabled. Please contact us for more information about our AccountCredit Module (http://www.sparkcommerce.com/contact)");
        }
