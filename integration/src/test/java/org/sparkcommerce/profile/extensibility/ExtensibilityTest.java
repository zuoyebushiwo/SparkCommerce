 ...
 * #L%
 */
package org.sparkcommerce.profile.extensibility;

import org.sparkcommerce.common.extensibility.context.MergeClassPathXMLApplicationContext;
...
public class ExtensibilityTest extends BaseTest {
    ...
    public void test() {
        try {
             ...
             */
            MergeClassPathXMLApplicationContext test = new MergeClassPathXMLApplicationContext(new String[]{"org/sparkcommerce/extensibility/base/applicationContext-src.xml","org/sparkcommerce/extensibility/base/applicationContext-src2.xml"}, new String[]{"org/sparkcommerce/extensibility/override/applicationContext-patch1.xml","org/sparkcommerce/extensibility/override/applicationContext-patch2.xml"}, null);
