...
import org.sparkcommerce.core.catalog.domain.CategoryProductXrefImpl;
...
public class MVELTest extends BaseTest {
    ...
    public MVELTest() {
        InputStream is = this.getClass().getResourceAsStream("/org/sparkcommerce/core/offer/service/mvelFunctions.mvel");
        try {
