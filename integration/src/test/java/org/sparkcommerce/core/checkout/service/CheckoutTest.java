 ...
 * #L%
 */
package org.sparkcommerce.core.checkout.service;

import org.sparkcommerce.common.currency.SparkCurrencyProvider;
...
import org.sparkcommerce.core.catalog.domain.SkuImpl;
...
import org.sparkcommerce.core.order.domain.DiscreteOrderItemImpl;
import org.sparkcommerce.core.order.domain.FulfillmentGroup;
import org.sparkcommerce.core.order.domain.FulfillmentGroupImpl;
import org.sparkcommerce.core.order.domain.FulfillmentGroupItem;
import org.sparkcommerce.core.order.domain.FulfillmentGroupItemImpl;
import org.sparkcommerce.core.order.domain.Order;
import org.sparkcommerce.core.order.domain.OrderItem;
import org.sparkcommerce.core.order.fulfillment.domain.FixedPriceFulfillmentOption;
import org.sparkcommerce.core.order.fulfillment.domain.FixedPriceFulfillmentOptionImpl;
...
import org.sparkcommerce.core.payment.domain.PaymentTransaction;
import org.sparkcommerce.core.payment.domain.PaymentTransactionImpl;
import org.sparkcommerce.core.payment.domain.secure.CreditCardPayment;
import org.sparkcommerce.core.payment.service.NullPaymentGatewayType;
...
import org.sparkcommerce.profile.core.domain.Country;
import org.sparkcommerce.profile.core.domain.CountryImpl;
import org.sparkcommerce.profile.core.domain.Customer;
import org.sparkcommerce.profile.core.domain.State;
import org.sparkcommerce.profile.core.domain.StateImpl;
...
public class CheckoutTest extends BaseTest {
    ...
    protected SparkCurrencyService currencyService;

    @Test(groups = { "checkout" }, dependsOnGroups = { "createCartForCustomer", "testShippingInsert" }, dataProvider = "USCurrency", dataProviderClass = SparkCurrencyProvider.class)
    @Transactional
    public void testCheckout(SparkCurrency usCurrency) throws Exception {
