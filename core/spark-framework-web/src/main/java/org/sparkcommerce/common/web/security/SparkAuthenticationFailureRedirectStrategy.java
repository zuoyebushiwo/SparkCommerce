 ...
 * 
 * Tacks on the SC_AJAX_PARAMETER=true to the redirect request if the request is an ajax request.   This will cause the
...
public class SparkAuthenticationFailureRedirectStrategy implements RedirectStrategy {
