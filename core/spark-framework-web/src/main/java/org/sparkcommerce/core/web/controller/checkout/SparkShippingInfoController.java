...
import org.sparkcommerce.core.web.checkout.model.MultiShipInstructionForm;
import org.sparkcommerce.core.web.checkout.model.OrderMultishipOptionForm;
 ...
 */
public class SparkShippingInfoController extends AbstractCheckoutController {
     ...
     * @throws org.sparkcommerce.core.pricing.service.exception.PricingException
     */
     ...
     *
     * Note:  the default Spark implementation creates an order
     ...
     * @throws org.sparkcommerce.common.exception.ServiceException
     */
     ...
     *
     * Note that the default Spark implementation will require the user to input
