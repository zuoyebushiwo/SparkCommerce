...
import org.sparkcommerce.core.catalog.domain.ProductOptionXref;
...
import org.sparkcommerce.core.order.domain.SkuAccessor;
 ...
 * 
 * Spark provides this example but most clients with typical customizations will need to create a similar processor
 * to meet their dynamic data caching needs.
 * 
 * The Spark processor works with the sample javacript function in HeatClinic found in heatClinic-UncacheableData.js work 
 * together to update the "In Cart", "Out of Stock", "Welcome {name}", and "Cart Qty" messages.   By doing this, the 
 * category and product pages in HeatClinic can be aggressively cached using the {@link SparkCacheProcessor}. 
 * 
