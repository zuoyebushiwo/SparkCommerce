...
import org.sparkcommerce.core.checkout.service.gateway.PassthroughPaymentConstants;
 ...
 */
public class SparkCheckoutController extends AbstractCheckoutController {

    private static final Log LOG = LogFactory.getLog(SparkCheckoutController.class);
