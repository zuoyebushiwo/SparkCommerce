...
public class PriceTextDisplayProcessor extends AbstractTextChildModifierAttrProcessor {
    ...
    protected String getText(Arguments arguments, Element element, String attributeName) {
        ...
        if (brc.getJavaLocale() != null) {
            return SparkCurrencyUtils.getNumberFormatFromCache(brc.getJavaLocale(), price.getCurrency()).format(price.getAmount());
        } else {
            // Setup your SC_CURRENCY and SC_LOCALE to display a diff default.
