...
import org.sparkcommerce.profile.web.core.security.CustomerStateInterceptor;
...
/**
 * Interceptor responsible for putting the current cart on the request. Carts are defined in SC as an {@link Order} with
