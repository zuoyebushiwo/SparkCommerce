 ...
 * #L%
 */
package org.sparkcommerce.core.web.api.endpoint.catalog;
...
import org.sparkcommerce.common.media.domain.Media;
...
import org.sparkcommerce.core.catalog.domain.CategoryAttribute;
import org.sparkcommerce.core.catalog.domain.CategoryProductXref;
import org.sparkcommerce.core.catalog.domain.Product;
import org.sparkcommerce.core.catalog.domain.ProductAttribute;
import org.sparkcommerce.core.catalog.domain.RelatedProduct;
import org.sparkcommerce.core.catalog.domain.Sku;
import org.sparkcommerce.core.catalog.domain.SkuAttribute;
import org.sparkcommerce.core.catalog.service.CatalogService;
import org.sparkcommerce.core.inventory.service.InventoryService;
...
import org.sparkcommerce.core.search.service.SearchService;
...
import org.sparkcommerce.core.web.api.wrapper.CategoriesWrapper;
import org.sparkcommerce.core.web.api.wrapper.CategoryAttributeWrapper;
import org.sparkcommerce.core.web.api.wrapper.CategoryWrapper;
import org.sparkcommerce.core.web.api.wrapper.InventoryWrapper;
import org.sparkcommerce.core.web.api.wrapper.MediaWrapper;
import org.sparkcommerce.core.web.api.wrapper.ProductAttributeWrapper;
import org.sparkcommerce.core.web.api.wrapper.ProductWrapper;
import org.sparkcommerce.core.web.api.wrapper.RelatedProductWrapper;
import org.sparkcommerce.core.web.api.wrapper.SearchResultsWrapper;
import org.sparkcommerce.core.web.api.wrapper.SkuAttributeWrapper;
import org.sparkcommerce.core.web.api.wrapper.SkuWrapper;
import org.sparkcommerce.core.web.service.SearchFacetDTOService;
...
public abstract class CatalogEndpoint extends BaseEndpoint {
    ...
    /**
     * This uses Spark's search service to search for products within a category.
     * @param request
     * @param q
     * @param categoryId
     * @param pageSize
    ...
    public SearchResultsWrapper findProductsByCategoryAndQuery(HttpServletRequest request,
        ...
        try {
            if (StringUtils.isNotEmpty(q)) {
                ...
                throw SparkWebServicesException.build(Response.Status.BAD_REQUEST.getStatusCode())
                        .addMessage(SparkWebServicesException.SEARCH_QUERY_EMPTY);
            }
        } catch (ServiceException e) {
            throw SparkWebServicesException.build(Response.Status.BAD_REQUEST.getStatusCode())
                    .addMessage(SparkWebServicesException.SEARCH_QUERY_MALFORMED, q);
        }

        if (categoryId == null) {
            throw SparkWebServicesException.build(Response.Status.BAD_REQUEST.getStatusCode())
                    .addMessage(SparkWebServicesException.INVALID_CATEGORY_ID, categoryId);
        }
    ...
    public SearchResultsWrapper findProductsByQuery(HttpServletRequest request,
        ...
        try {
            ...
            throw SparkWebServicesException.build(Response.Status.INTERNAL_SERVER_ERROR.getStatusCode())
                    .addMessage(SparkWebServicesException.SEARCH_ERROR);
    ...
    public CategoriesWrapper findSubCategories(HttpServletRequest request,
        ...
        throw SparkWebServicesException.build(Response.Status.NOT_FOUND.getStatusCode())
                .addMessage(SparkWebServicesException.CATEGORY_NOT_FOUND, id);
    ...
    public CategoryWrapper findCategoryByIdOrName(HttpServletRequest request,
        ...
        throw SparkWebServicesException.build(Response.Status.NOT_FOUND.getStatusCode())
                .addMessage(SparkWebServicesException.CATEGORY_NOT_FOUND, searchParameter);
    }
    ...
    public List<InventoryWrapper> findInventoryForSkus(HttpServletRequest request, List<Long> ids) {
        ...
        throw SparkWebServicesException.build(Response.Status.NOT_FOUND.getStatusCode())
                .addMessage(SparkWebServicesException.SKU_NOT_FOUND, skus.toArray());
    }
