...
import org.sparkcommerce.core.web.api.endpoint.catalog.CatalogEndpoint;
...
public abstract class CartEndpoint extends BaseEndpoint {
   ...
   /**
    ...
    public OrderWrapper removeItemFromOrder(HttpServletRequest request,
        ...
        try {
            ...
            if (e.getCause() instanceof ItemNotFoundException) {
                throw SparkWebServicesException.build(Response.Status.NOT_FOUND.getStatusCode(), null, null, e.getCause())
                        .addMessage(SparkWebServicesException.CART_ITEM_NOT_FOUND, itemId);
            } else {
                throw SparkWebServicesException.build(Response.Status.INTERNAL_SERVER_ERROR.getStatusCode(), null, null, e);
            }
        }
    ...
    public OrderWrapper updateItemQuantity(HttpServletRequest request,
        ...
        try {
            ...
            if (e.getCause() instanceof ItemNotFoundException) {
                ...
                throw SparkWebServicesException.build(Response.Status.INTERNAL_SERVER_ERROR.getStatusCode(), null, null, e)
                        .addMessage(SparkWebServicesException.UPDATE_CART_ERROR);
            }
        } catch (RemoveFromCartException e) {
            if (e.getCause() instanceof ItemNotFoundException) {
                throw SparkWebServicesException.build(Response.Status.NOT_FOUND.getStatusCode(), null, null, e.getCause())
           ...
           throw SparkWebServicesException.build(Response.Status.INTERNAL_SERVER_ERROR.getStatusCode(), null, null, pe)
                    .addMessage(SparkWebServicesException.CART_PRICING_ERROR);
        }
    }
    ...
    public OrderWrapper addOfferCode(HttpServletRequest request,
        ...
        if (offerCode == null) {
            throw SparkWebServicesException.build(Response.Status.NOT_FOUND.getStatusCode())
                    .addMessage(SparkWebServicesException.PROMO_CODE_INVALID, promoCode);
        }
        ...
        try {
            ...
            throw SparkWebServicesException.build(Response.Status.BAD_REQUEST.getStatusCode(), null, null, e)
                    .addMessage(SparkWebServicesException.PROMO_CODE_MAX_USAGES, promoCode);
        }
    }
