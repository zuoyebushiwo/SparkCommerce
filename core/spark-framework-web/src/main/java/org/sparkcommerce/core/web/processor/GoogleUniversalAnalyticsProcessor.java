...
public class GoogleUniversalAnalyticsProcessor extends AbstractElementProcessor {
    ...
    public String getAffiliation() {
        return SCSystemProperty.resolveSystemProperty("googleAnalytics.affiliation");
    }
    
    public String getWebPropertyId() {
        return SCSystemProperty.resolveSystemProperty("googleAnalytics.webPropertyId");
    }
    
    public boolean isIncludeLinkAttribution() {
        return SCSystemProperty.resolveBooleanSystemProperty("googleAnalytics.enableLinkAttribution", true);
    }

    public boolean isIncludeDisplayAdvertising() {
        return SCSystemProperty.resolveBooleanSystemProperty("googleAnalytics.enableDisplayAdvertising", false);
    }
