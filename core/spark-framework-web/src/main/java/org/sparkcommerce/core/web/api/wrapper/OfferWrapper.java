...
public class OfferWrapper extends BaseWrapper implements APIWrapper<Offer> {
    ...
    @XmlElement
    protected SparkEnumerationTypeWrapper offerType;

    @XmlElement
    protected SparkEnumerationTypeWrapper discountType;
    @XmlElement
    ...
    public void wrapSummary(Offer model, HttpServletRequest request) {
        ...
        this.offerType = (SparkEnumerationTypeWrapper) context.getBean(SparkEnumerationTypeWrapper.class.getName());
        this.offerType.wrapDetails(model.getType(), request);
        this.discountType = (SparkEnumerationTypeWrapper) context.getBean(SparkEnumerationTypeWrapper.class.getName());
