 ...
 * @see {@link SparkWebRequestProcessor}
...
public class CartStateRequestProcessor extends AbstractSparkWebRequestProcessor {
    ...
    public void process(WebRequest request) {
        ...
        Map<String, Object> ruleMap = (Map<String, Object>) request.getAttribute(SC_RULE_MAP_PARAM, WebRequest.SCOPE_REQUEST);
        if (ruleMap == null) {
