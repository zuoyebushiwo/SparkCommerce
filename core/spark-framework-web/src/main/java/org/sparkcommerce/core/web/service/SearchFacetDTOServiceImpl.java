...
import org.sparkcommerce.core.search.domain.SearchFacetResultDTO;
...
public class SearchFacetDTOServiceImpl implements SearchFacetDTOService {
    ...
    protected int getDefaultPageSize() {
        return SCSystemProperty.resolveIntSystemProperty("web.defaultPageSize");
    }

    protected int getMaxPageSize() {
        return SCSystemProperty.resolveIntSystemProperty("web.maxPageSize");
    }
