...
import org.sparkcommerce.core.order.service.OrderLockManager;
import org.sparkcommerce.core.order.service.OrderService;
import org.sparkcommerce.core.web.order.CartState;
import org.sparkcommerce.core.web.order.security.exception.OrderLockAcquisitionFailureException;
...
/**
 * <p>
 * This filter should be configured after the SparkCommerce CustomerStateFilter listener from Spring Security.
 * Retrieves the cart for the current SparkCommerce Customer based using the authenticated user OR creates an empty non-modifiable cart and
...
public class CartStateFilter extends GenericFilterBean implements  Ordered {
     ...
     *
     * <bean id="blCartStateFilter" class="org.sparkcommerce.core.web.order.security.CartStateFilter">
    ...
    protected boolean getErrorInsteadOfQueue() {
        return SCSystemProperty.resolveBooleanSystemProperty("order.lock.errorInsteadOfQueue");
    }
