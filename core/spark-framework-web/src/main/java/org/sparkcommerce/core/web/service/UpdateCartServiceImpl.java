...
import org.sparkcommerce.core.order.service.call.UpdateCartResponse;
...
import org.sparkcommerce.core.web.order.model.AddToCartItem;
...
public class UpdateCartServiceImpl implements UpdateCartService {
    ...
    protected static SparkCurrency savedCurrency;
    ...
    public boolean currencyHasChanged() {
        SparkCurrency currency = findActiveCurrency();
    ...
    protected SparkCurrency findActiveCurrency(){
        if(SparkRequestContext.hasLocale()){
            return SparkRequestContext.getSparkRequestContext().getSparkCurrency();
        }
        return null;
    }

    protected boolean checkAvailabilityInLocale(DiscreteOrderItem doi, SparkCurrency currency) {
    ...
    @Override
    public void setSavedCurrency(SparkCurrency savedCurrency) {
        this.savedCurrency = savedCurrency;
    }

    @Override
    public SparkCurrency getSavedCurrency() {
