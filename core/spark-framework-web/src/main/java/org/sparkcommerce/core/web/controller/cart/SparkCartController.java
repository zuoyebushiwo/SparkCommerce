...
import org.sparkcommerce.common.util.SCMessageUtils;
 ...
 */
public class SparkCartController extends AbstractCartController {
    ...
    public Map<String, String> handleIllegalCartOpException(IllegalCartOperationException ex) {
        ...
        returnMap.put("exception", SCMessageUtils.getMessage(ex.getType()));
        return returnMap;
    }
