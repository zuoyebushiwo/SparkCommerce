...
import org.sparkcommerce.core.web.service.SimpleCacheKeyResolver;
import org.sparkcommerce.core.web.service.TemplateCacheKeyResolverService;
 ...
 * 
 * <p>
 * Implementors can create more functional cacheKey mechanisms. For example, Spark Enterprise provides an 
 ...
 */
public class SparkCacheProcessor extends AbstractAttrProcessor {

    private static final Log LOG = LogFactory.getLog(SparkCacheProcessor.class);
