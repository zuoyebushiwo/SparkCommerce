...
public interface SkuDao {
     ...
     * to determine which polymorphic version of {@code Sku} to instantiate. To make Spark instantiate your
     ...
     *
     * @return a {@code Sku} instance based on the Spark entity configuration.
     */
    public Sku create();
