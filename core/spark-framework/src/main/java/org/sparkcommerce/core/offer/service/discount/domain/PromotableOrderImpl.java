...
import org.sparkcommerce.core.offer.service.discount.OrderItemPriceComparator;
...
public class PromotableOrderImpl implements PromotableOrder {
    ...
    public Money calculateOrderAdjustmentTotal() {
        Money orderAdjustmentTotal = SparkCurrencyUtils.getMoney(order.getCurrency());
        for (PromotableOrderAdjustment adjustment : candidateOrderOfferAdjustments) {
    ...
    public Money calculateItemAdjustmentTotal() {
        Money itemAdjustmentTotal = SparkCurrencyUtils.getMoney(order.getCurrency());
    ...
    public SparkCurrency getOrderCurrency() {
    ...
    public Money calculateSubtotalWithoutAdjustments() {
        Money calculatedSubTotal = SparkCurrencyUtils.getMoney(order.getCurrency());
