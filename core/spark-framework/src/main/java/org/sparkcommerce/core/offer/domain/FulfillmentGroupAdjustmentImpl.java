...
public class FulfillmentGroupAdjustmentImpl implements FulfillmentGroupAdjustment, CurrencyCodeIdentifiable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.FulfillmentGroupAdjustmentImpl")
        }
    )
    ...
    public Money getValue() {
        return value == null ? null : SparkCurrencyUtils.getMoney(value, getFulfillmentGroup().getOrder().getCurrency());
    }
