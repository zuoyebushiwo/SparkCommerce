 ...
 * that implement this interface should be stored in a completely separate database under strict PCI compliance. Spark
 ...
 * via {@link SecureOrderPaymentService#create(org.sparkcommerce.core.payment.service.type.PaymentType)}</p>
 * 
...
public interface Referenced extends Serializable {
     ...
     * {@link SecureOrderPaymentService#findSecurePaymentInfo(String, org.sparkcommerce.core.payment.service.type.PaymentType)}
     * and {@link SecureOrderPaymentService#create(org.sparkcommerce.core.payment.service.type.PaymentType)}.
     * 
     * @see {@link SecureOrderPaymentService#findSecurePaymentInfo(String, org.sparkcommerce.core.payment.service.type.PaymentType)}
     * @see {@link SecureOrderPaymentService#create(org.sparkcommerce.core.payment.service.type.PaymentType)}
     */
