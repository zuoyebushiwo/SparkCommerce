...
@Table(name = "SC_DISC_ITEM_FEE_PRICE")
...
public class DiscreteOrderItemFeePriceImpl implements DiscreteOrderItemFeePrice  {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.order.domain.DiscreteOrderItemFeePriceImpl")
        }
    )
    ...
    public void checkCloneable(DiscreteOrderItemFeePrice discreteFeePrice) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("org.sparkcommerce") && !discreteFeePrice.getClass().getName().startsWith("org.sparkcommerce")) {
