...
public class PaymentLogImpl implements PaymentLog {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.payment.domain.PaymentLogImpl")
        }
    )
    ...
    public Money getAmountPaid() {
        return SparkCurrencyUtils.getMoney(amountPaid, currency);
    }
