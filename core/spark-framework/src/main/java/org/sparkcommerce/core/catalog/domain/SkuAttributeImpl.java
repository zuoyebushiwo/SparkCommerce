...
public class SkuAttributeImpl implements SkuAttribute {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.catalog.domain.SkuAttributeImpl")
        }
    )
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#getId()
     */
    @Override
    public Long getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#setId(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#getValue()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#setValue(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#getSearchable()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#setSearchable(java.lang.Boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#getName()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#setName(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#getSku()
     */
    @Override
    public Sku getSku() {
        return sku;
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.SkuAttribute#setSku(org.sparkcommerce.core.catalog.domain.Sku)
     */
    @Override
