...
import org.sparkcommerce.core.catalog.domain.CategorySiteMapGeneratorConfiguration;
...
public class CategorySiteMapGenerator implements SiteMapGenerator {
    ...
    protected String generateUri(SiteMapBuilder siteMapBuilder, Category category) {
        return SparkFileUtils.appendUnixPaths(siteMapBuilder.getBaseUrl(), category.getUrl());
    }
