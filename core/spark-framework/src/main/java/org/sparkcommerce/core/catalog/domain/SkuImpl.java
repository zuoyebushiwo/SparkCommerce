...
import org.sparkcommerce.common.presentation.AdminPresentationMapField;
import org.sparkcommerce.common.presentation.AdminPresentationMapFields;
...
import org.sparkcommerce.core.catalog.domain.ProductImpl.Presentation;
import org.sparkcommerce.core.catalog.service.dynamic.DefaultDynamicSkuPricingInvocationHandler;
import org.sparkcommerce.core.catalog.service.dynamic.DynamicSkuPrices;
import org.sparkcommerce.core.catalog.service.dynamic.SkuActiveDateConsiderationContext;
import org.sparkcommerce.core.catalog.service.dynamic.SkuPricingConsiderationContext;
 ...
 * annotations. The Entity references the following tables: SC_SKU,
 * SC_SKU_IMAGE
 *
 * !!!!!!!!!!!!!!!!!
 ...
 * {@link AdminPresentation#requiredOverride()}, use the mo:overrides section in spark-admin-applicationContext.xml for Product
...
public class SkuImpl implements Sku {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name = "entity_name", value = "org.sparkcommerce.core.catalog.domain.SkuImpl")
        }
    )
    @Column(name = "SKU_ID")
    ...
    @JoinTable(name = "SC_SKU_MEDIA_MAP", 
    ...
    @JoinTable(name = "SC_PRODUCT_SKU_XREF", 
    ...
    @JoinTable(name = "SC_SKU_OPTION_VALUE_XREF", 
        joinColumns = @JoinColumn(name = "SKU_ID", referencedColumnName = "SKU_ID"), 
    ...
    //Use a Set instead of a List - see https://github.com/SparkCommerce/SparkCommerce/issues/917
    ...
    @ElementCollection
    @CollectionTable(name = "SC_SKU_FULFILLMENT_FLAT_RATES", 
        joinColumns = @JoinColumn(name = "SKU_ID", referencedColumnName = "SKU_ID", nullable = true))
    ...
    @JoinTable(name = "SC_SKU_FULFILLMENT_EXCLUDED",
            joinColumns = @JoinColumn(name = "SKU_ID", referencedColumnName = "SKU_ID"),
