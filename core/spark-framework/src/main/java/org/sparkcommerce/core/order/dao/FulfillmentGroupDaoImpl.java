...
public class FulfillmentGroupDaoImpl implements FulfillmentGroupDao {
    ...
    public FulfillmentGroup createDefault() {
        final FulfillmentGroup fg = ((FulfillmentGroup) entityConfiguration.createEntityInstance("org.sparkcommerce.core.order.domain.FulfillmentGroup"));
        fg.setPrimary(true);
        return fg;
    }
    ...
    public FulfillmentGroupFee createFulfillmentGroupFee() {
        return ((FulfillmentGroupFee) entityConfiguration.createEntityInstance("org.sparkcommerce.core.order.domain.FulfillmentGroupFee"));
    }
