 ...
 * #L%
 */
package org.sparkcommerce.core.inventory.domain;
...
import org.sparkcommerce.core.inventory.service.type.AvailabilityStatusType;
...
@Table(name = "SC_SKU_AVAILABILITY")
...
public class SkuAvailabilityImpl implements SkuAvailability {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.inventory.domain.SkuAvailabilityImpl")
        }
    )
    ...
    @AdminPresentation(friendlyName = "SkuAvailabilityImpl_Availability_Status", group = "SkuAvailabilityImpl_Description", fieldType= SupportedFieldType.BROADLEAF_ENUMERATION, sparkEnumeration="org.sparkcommerce.core.inventory.service.type.AvailabilityStatusType")
