...
public abstract class FulfillmentBandImpl implements FulfillmentBand {
    ...
    @AdminPresentation(friendlyName="Result Type", fieldType=SupportedFieldType.BROADLEAF_ENUMERATION, sparkEnumeration="org.sparkcommerce.core.order.service.type.FulfillmentBandResultAmountType")
