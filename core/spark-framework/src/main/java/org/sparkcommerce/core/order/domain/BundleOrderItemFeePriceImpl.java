...
@Table(name = "SC_BUND_ITEM_FEE_PRICE")
...
public class BundleOrderItemFeePriceImpl implements BundleOrderItemFeePrice  {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.order.domain.BundleOrderItemFeePriceImpl")
        }
    )
    ...
    public void checkCloneable(BundleOrderItemFeePrice bundleFeePrice) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("org.sparkcommerce") && !bundleFeePrice.getClass().getName().startsWith("org.sparkcommerce")) {
    ...
    protected Money convertToMoney(BigDecimal amount) {
        return amount == null ? null : SparkCurrencyUtils.getMoney(amount, bundleOrderItem.getOrder().getCurrency());
    }
