 ...
 * #L%
 */
package org.sparkcommerce.core.pricing.service.fulfillment.provider;
...
import org.sparkcommerce.common.util.UnitOfMeasureUtil;
import org.sparkcommerce.common.util.WeightUnitOfMeasureType;
...
import org.sparkcommerce.core.order.fulfillment.domain.BandedWeightFulfillmentOption;
import org.sparkcommerce.core.order.fulfillment.domain.FulfillmentBand;
import org.sparkcommerce.core.order.fulfillment.domain.FulfillmentPriceBand;
import org.sparkcommerce.core.order.fulfillment.domain.FulfillmentWeightBand;
import org.sparkcommerce.core.order.service.type.FulfillmentBandResultAmountType;
    ...
    public FulfillmentEstimationResponse estimateCostForFulfillmentGroup(FulfillmentGroup fulfillmentGroup, Set<FulfillmentOption> options) throws FulfillmentPriceException {
        ...
        for (FulfillmentOption option : options) {
            if (canCalculateCostForFulfillmentGroup(fulfillmentGroup, option)) {
                ...
                shippingPrices.put(option, SparkCurrencyUtils.getMoney(lowestBandFulfillmentPrice, fulfillmentGroup.getOrder().getCurrency()));
            }
        }
