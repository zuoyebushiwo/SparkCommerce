...
import org.sparkcommerce.common.extensibility.jpa.clone.ClonePolicy;
...
import org.sparkcommerce.common.vendor.service.type.ContainerShapeType;
import org.sparkcommerce.common.vendor.service.type.ContainerSizeType;
import org.sparkcommerce.common.web.SparkRequestContext;
import org.sparkcommerce.common.web.Locatable;
import org.sparkcommerce.core.catalog.extension.ProductEntityExtensionManager;
 ...
 * annotations. The Entity references the following tables: SC_PRODUCT,
 * SC_PRODUCT_SKU_XREF, SC_PRODUCT_IMAGE
 * @author btaylor
 * @see {@link Product}, {@link SkuImpl}, {@link CategoryImpl}
 */
@Entity
@Inheritance(strategy = InheritanceType.JOINED)
@javax.persistence.Table(name="SC_PRODUCT")
//multi-column indexes don't appear to get exported correctly when declared at the field level, so declaring here as a workaround
@org.hibernate.annotations.Table(appliesTo = "SC_PRODUCT", indexes = {
...
@SQLDelete(sql="UPDATE SC_PRODUCT SET ARCHIVED = 'Y' WHERE PRODUCT_ID = ?")
@DirectCopyTransform({
...
public class ProductImpl implements Product, Status, AdminMainEntity, Locatable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.catalog.domain.ProductImpl")
        }
    )
    ...
    @AdminPresentationAdornedTargetCollection(friendlyName = "productOptionsTitle",
        tab = Presentation.Tab.Name.ProductOptions, tabOrder = Presentation.Tab.Order.ProductOptions,
        joinEntityClass = "org.sparkcommerce.core.catalog.domain.ProductOptionXrefImpl",
