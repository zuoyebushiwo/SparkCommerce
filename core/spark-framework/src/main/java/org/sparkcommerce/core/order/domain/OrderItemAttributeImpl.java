 ...
 *
 * @see org.sparkcommerce.core.order.domain.OrderItemAttribute
 */
@Entity
@Inheritance(strategy = InheritanceType.JOINED)
@Table(name="SC_ORDER_ITEM_ATTRIBUTE")
...
public class OrderItemAttributeImpl implements OrderItemAttribute {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.catalog.domain.OrderItemAttributeImpl")
        }
    )
    ...
    public void checkCloneable(OrderItemAttribute itemAttribute) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("org.sparkcommerce") && !itemAttribute.getClass().getName().startsWith("org.sparkcommerce")) {
    ...
    public OrderItemAttribute clone() {
        ...
        try {
            ...
            try {
                ...
                LOG.warn("Clone implementation missing in inheritance hierarchy outside of Spark: " + itemAttribute.getClass().getName(), e);
            }            
