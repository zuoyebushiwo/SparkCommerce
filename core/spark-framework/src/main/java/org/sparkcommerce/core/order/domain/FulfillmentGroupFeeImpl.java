...
@Table(name = "SC_FULFILLMENT_GROUP_FEE")
...
public class FulfillmentGroupFeeImpl implements FulfillmentGroupFee, CurrencyCodeIdentifiable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.order.domain.FulfillmentGroupFeeImpl")
        }
    )
    ...
    @JoinTable(name = "SC_FG_FEE_TAX_XREF", joinColumns = @JoinColumn(name = "FULFILLMENT_GROUP_FEE_ID"), inverseJoinColumns = @JoinColumn(name = "TAX_DETAIL_ID"))
    ...
    public Money getAmount() {
        return amount == null ? null : SparkCurrencyUtils.getMoney(amount, getFulfillmentGroup().getOrder().getCurrency());
    }
