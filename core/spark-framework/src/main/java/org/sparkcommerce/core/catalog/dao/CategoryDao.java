...
public interface CategoryDao {
     ...
     *
     * Spark allows more than one category to have the same name. Calling
     ...
     * to determine which polymorphic version of {@code Category} to instantiate. To make Spark instantiate your
     ...
     *
     * @return a {@code Category} instance based on the Spark entity configuration.
     */
    @Nonnull
