...
public class OfferInfoImpl implements OfferInfo {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.OfferInfoImpl")
        }
    )
    ...
    @CollectionTable(name="SC_OFFER_INFO_FIELDS", joinColumns=@JoinColumn(name="OFFER_INFO_FIELDS_ID"))
    @BatchSize(size = 50)
