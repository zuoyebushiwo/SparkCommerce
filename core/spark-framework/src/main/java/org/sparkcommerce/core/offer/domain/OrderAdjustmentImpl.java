...
@Entity
@Table(name = "SC_ORDER_ADJUSTMENT")
...
public class OrderAdjustmentImpl implements OrderAdjustment, CurrencyCodeIdentifiable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.OrderAdjustmentImpl")
        }
    )
    ...
    public Money getValue() {
        return value == null ? null : SparkCurrencyUtils.getMoney(value, getOrder().getCurrency());
    }
