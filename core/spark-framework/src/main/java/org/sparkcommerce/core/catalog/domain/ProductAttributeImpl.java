...
@Table(name="SC_PRODUCT_ATTRIBUTE")
...
public class ProductAttributeImpl implements ProductAttribute {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.catalog.domain.ProductAttributeImpl")
        }
    )
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#getId()
     */
    @Override
    public Long getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#setId(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#getValue()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#setValue(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#getSearchable()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#setSearchable(java.lang.Boolean)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#getName()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#setName(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#getProduct()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.catalog.domain.ProductAttribute#setProduct(org.sparkcommerce.core.catalog.domain.Product)
     */
    @Override
