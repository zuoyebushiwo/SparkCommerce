...
import org.sparkcommerce.common.money.BankersRounding;
...
import org.sparkcommerce.core.offer.service.discount.FulfillmentGroupOfferPotential;
...
public class FulfillmentGroupOfferProcessorImpl extends OrderOfferProcessorImpl implements FulfillmentGroupOfferProcessor {
    ...
    public void calculateFulfillmentGroupTotal(PromotableOrder order) {
        Money totalFulfillmentCharges = SparkCurrencyUtils.getMoney(BigDecimal.ZERO, order.getOrderCurrency());
    ...
    protected boolean compareAndAdjustFulfillmentGroupOffers(PromotableOrder order, boolean fgOfferApplied) {
        Money regularOrderDiscountShippingTotal =
                SparkCurrencyUtils.getMoney(BigDecimal.ZERO, order.getOrderCurrency());
        ...
        Money discountOrderRegularShippingTotal = SparkCurrencyUtils.getMoney(BigDecimal.ZERO, order.getOrderCurrency());
