...
public class MergeCartServiceImpl implements MergeCartService {
    ...
    /**
     * By default, Spark does not provide an inventory check. This is set up as an extension point if your
    ...
    /**
     * By default, Spark does not provide additional validity checks. This is set up as an extension point if your
     * application needs it.
     * 
     * @param orderItem
