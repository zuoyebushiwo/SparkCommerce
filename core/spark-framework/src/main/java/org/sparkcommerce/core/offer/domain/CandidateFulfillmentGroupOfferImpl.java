...
@Entity
@Table(name = "SC_CANDIDATE_FG_OFFER")
...
public class CandidateFulfillmentGroupOfferImpl implements CandidateFulfillmentGroupOffer {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.CandidateFulfillmentGroupOfferImpl")
        }
    )
    ...
    public Money getDiscountedPrice() {
        return discountedPrice == null ? null : SparkCurrencyUtils.getMoney(discountedPrice, getFulfillmentGroup().getOrder().getCurrency());
    }
