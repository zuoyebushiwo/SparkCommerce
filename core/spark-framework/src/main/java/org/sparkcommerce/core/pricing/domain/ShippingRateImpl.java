 ...
 * #L%
 */
package org.sparkcommerce.core.pricing.domain;
...
public class ShippingRateImpl implements ShippingRate {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.pricing.domain.ShippingRateImpl")
        }
    )
    @Column(name = "ID")
    protected Long id;
