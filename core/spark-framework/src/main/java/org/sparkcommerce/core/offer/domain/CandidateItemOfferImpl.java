...
import org.sparkcommerce.core.order.domain.OrderItemImpl;
...
@Entity
@Table(name = "SC_CANDIDATE_ITEM_OFFER")
...
public class CandidateItemOfferImpl implements CandidateItemOffer, Cloneable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.CandidateItemOfferImpl")
        }
    )
    ...
    public Money getDiscountedPrice() {
        return discountedPrice == null ? null : SparkCurrencyUtils.getMoney(discountedPrice, getOrderItem().getOrder().getCurrency());
    }
    ...
    public void checkCloneable(CandidateItemOffer itemOffer) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("org.sparkcommerce") && !itemOffer.getClass().getName().startsWith("org.sparkcommerce")) {
    ...
    public CandidateItemOffer clone() {
        ...
        try {
            ...
            try {
                ...
                LOG.warn("Clone implementation missing in inheritance hierarchy outside of Spark: " + candidateItemOffer.getClass().getName(), e);
            }
