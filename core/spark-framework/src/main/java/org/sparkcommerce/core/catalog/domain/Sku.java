...
import org.sparkcommerce.core.order.service.workflow.CheckAvailabilityActivity;
...
public interface Sku extends Serializable {
     ...
     * @return the {@link org.sparkcommerce.core.inventory.service.type.InventoryType} for this sku
     */
     ...
     * for this Sku.</p>
     * 
     * <p>In order to enable this feature in a Spark 3.1.1+ installation, you must hook up the {@link QuantityAvailableSkuTemplate}
