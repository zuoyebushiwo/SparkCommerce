...
@SQLDelete(sql="UPDATE SC_OFFER_CODE SET ARCHIVED = 'Y' WHERE OFFER_CODE_ID = ?")
@DirectCopyTransform({
...
public class OfferCodeImpl implements OfferCode {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.OfferCodeImpl")
        }
    )
