 ...
 * In Spark Commerce, a Cart and an Order are the same thing. A "cart" becomes 
...
public interface OrderService {
     ...
     * utility class.
     * 
     * The default Spark implementation of this method will provision a new Order in the 
     ...
     * 
     * @see org.sparkcommerce.profile.web.core.CustomerState#getCustomer()
     * 
     * @param customer
     ...
     * @param customer
     * @param args additional arguments to be used by Spark extensions
     ...
     * has more than one current IN_PROCESS Order, the default Spark implementation will
    ...
    /**
     * Deletes the given order. Note that the default Spark implementation in 
     ...
     * 
     * @see org.sparkcommerce.core.order.domain.NullOrderImpl for more information
     * 
     ...
     * The default Spark implementation will attempt to match on skuId first, and failing that, it will
