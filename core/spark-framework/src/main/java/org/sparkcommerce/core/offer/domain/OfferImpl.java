 ...
 * #L%
 */
package org.sparkcommerce.core.offer.domain;
...
import org.sparkcommerce.core.offer.extension.OfferEntityExtensionManager;
...
import org.sparkcommerce.core.offer.service.type.OfferItemRestrictionRuleType;
...
@SQLDelete(sql="UPDATE SC_OFFER SET ARCHIVED = 'Y' WHERE OFFER_ID = ?")
@DirectCopyTransform({
...
public class OfferImpl implements Offer, AdminMainEntity {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.OfferImpl")
        }
    )
    ...
    @AdminPresentation(friendlyName = "OfferImpl_Offer_Type", order = 3000, 
        ...
        sparkEnumeration="org.sparkcommerce.core.offer.service.type.OfferType")
    ...
    @AdminPresentation(friendlyName = "OfferImpl_Offer_Discount_Type", order = 1000, 
        ...
        fieldType=SupportedFieldType.BROADLEAF_ENUMERATION,
        sparkEnumeration="org.sparkcommerce.core.offer.service.type.OfferDiscountType")
    ...
    @AdminPresentation(friendlyName = "OfferImpl_Item_Qualifier_Rule", 
        ...
        sparkEnumeration = "org.sparkcommerce.core.offer.service.type.OfferItemRestrictionRuleType")
    ...
    @JoinTable(name = "SC_QUAL_CRIT_OFFER_XREF", joinColumns = @JoinColumn(name = "OFFER_ID"), 
    ...
    @OneToMany(fetch = FetchType.LAZY, targetEntity = OfferItemCriteriaImpl.class, cascade = {CascadeType.MERGE, CascadeType.PERSIST})
    @JoinTable(name = "SC_TAR_CRIT_OFFER_XREF", joinColumns = @JoinColumn(name = "OFFER_ID"), 
        inverseJoinColumns = @JoinColumn(name = "OFFER_ITEM_CRITERIA_ID"))
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region="blOffers")
    ...
    @JoinTable(name = "SC_OFFER_RULE_MAP", 
    ...
    public Money getQualifyingItemSubTotal() {
        return qualifyingItemSubTotal == null ? null : SparkCurrencyUtils.getMoney(qualifyingItemSubTotal, null);
    }
