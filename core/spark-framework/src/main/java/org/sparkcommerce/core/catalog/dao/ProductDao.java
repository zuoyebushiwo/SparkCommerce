 ...
 * #L%
 */
package org.sparkcommerce.core.catalog.dao;
...
public interface ProductDao {
     ...
     * {@code /SparkCommerce/core/SparkCommerceFramework/src/main/resources/spark-framework-applicationContext-entity.xml}
     * to determine which polymorphic version of {@code Product} to instantiate. To make Spark instantiate your
     * extension of {@code Product} by default, include an entity configuration bean in your application context xml similar to:
     * <p>
     * {@code
     *     <bean id="blEntityConfiguration" class="org.sparkcommerce.common.persistence.EntityConfiguration">
     ...
     * }
     * </p>
     * Declare the same key for your desired entity in your entity xml that is used in the Spark entity xml, but change the value to the fully
     ...
     * @return a {@code Product} instance based on the Spark entity configuration.
     */
