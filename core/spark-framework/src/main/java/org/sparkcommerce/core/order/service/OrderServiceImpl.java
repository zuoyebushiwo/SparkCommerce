...
import org.sparkcommerce.common.util.TableCreator;
...
import org.sparkcommerce.core.offer.service.exception.OfferMaxUseExceededException;
...
import org.sparkcommerce.core.order.domain.NullOrderFactory;
...
import org.sparkcommerce.core.order.service.exception.IllegalCartOperationException;
...
import org.sparkcommerce.core.order.service.exception.UpdateCartException;
...
import org.sparkcommerce.core.payment.dao.OrderPaymentDao;
import org.sparkcommerce.core.payment.domain.OrderPayment;
import org.sparkcommerce.core.payment.domain.secure.Referenced;
import org.sparkcommerce.core.payment.service.SecureOrderPaymentService;
import org.sparkcommerce.core.pricing.service.PricingService;
...
@ManagedResource(objectName="org.sparkcommerce:name=OrderService", description="Order Service", currencyTimeLimit=15)
public class OrderServiceImpl implements OrderService {
    ...
    public Order createNamedOrderForCustomer(String name, Customer customer) {
        ...
        if (SparkRequestContext.getSparkRequestContext() != null) {
            namedOrder.setLocale(SparkRequestContext.getSparkRequestContext().getLocale());
        }
