...
/**
 * Defines an order in Spark.    There are several key items to be aware of with the SC Order.
 * 
...
public interface Order extends Serializable {
     ...
     * {@link org.sparkcommerce.core.pricing.service.workflow.AdjustOrderPaymentsActivity} will adjust the value of the payment
