...
@Table(name = "SC_FULFILLMENT_GROUP_ITEM")
...
public class FulfillmentGroupItemImpl implements FulfillmentGroupItem, Cloneable, CurrencyCodeIdentifiable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.order.domain.FulfillmentGroupItemImpl")
        }
    )
    ...
    @JoinTable(name = "SC_FG_ITEM_TAX_XREF", joinColumns = @JoinColumn(name = "FULFILLMENT_GROUP_ITEM_ID"), inverseJoinColumns = @JoinColumn(name = "TAX_DETAIL_ID"))
    @Cache(usage=CacheConcurrencyStrategy.NONSTRICT_READ_WRITE, region="blOrderElements")
    ...
    protected Money convertToMoney(BigDecimal amount) {
        return amount == null ? null : SparkCurrencyUtils.getMoney(amount, orderItem.getOrder().getCurrency());
    }
    ...
    public Money getTotalTax() {
        return totalTax == null ? null : SparkCurrencyUtils.getMoney(totalTax, getFulfillmentGroup().getOrder().getCurrency());
    }
    ...
    public void checkCloneable(FulfillmentGroupItem fulfillmentGroupItem) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("org.sparkcommerce") && !orderItem.getClass().getName().startsWith("org.sparkcommerce")) {
    ...
    public FulfillmentGroupItem clone() {
        ...
        try {
            ...
            try {
                ...
                LOG.warn("Clone implementation missing in inheritance hierarchy outside of Spark: " + clonedFulfillmentGroupItem.getClass().getName(), e);
            }
