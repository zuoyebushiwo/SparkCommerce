...
import org.sparkcommerce.core.order.domain.OrderItemPriceDetailImpl;
...
@Table(name = "SC_ORDER_ITEM_DTL_ADJ")
...
public class OrderItemPriceDetailAdjustmentImpl implements OrderItemPriceDetailAdjustment, CurrencyCodeIdentifiable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name = "entity_name", value = "org.sparkcommerce.core.offer.domain.OrderItemPriceDetailAdjustmentImpl")
        }
    )
    ...
    protected SparkCurrency getCurrency() {
        return getOrderItemPriceDetail().getOrderItem().getOrder().getCurrency();
    }

    @Override
    public Money getValue() {
        return value == null ? null : SparkCurrencyUtils.getMoney(value, getCurrency());
    }
    ...
    public Money getRetailPriceValue() {
        if (retailValue == null) {
            return SparkCurrencyUtils.getMoney(BigDecimal.ZERO, getCurrency());
        }
