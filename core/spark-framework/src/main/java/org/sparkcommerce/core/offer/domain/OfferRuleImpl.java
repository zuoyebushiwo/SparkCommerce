...
public class OfferRuleImpl implements OfferRule {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.OfferRuleImpl")
        }
    )
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.OfferRule#getId()
     */
    @Override
    public Long getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.OfferRule#setId(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.OfferRule#getMatchRule()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.OfferRule#setMatchRule(java.lang.String)
     */
    @Override
