...
public interface OrderItem extends Serializable, Cloneable {
    ...
    /**
     * Sets the unique id of the OrderItem.   Typically left null for new items and Spark will
     ...
     * which will use the Spark dynamic pricing engine or the values directly tied to the SKU.
     * 
     * @param salePrice
     */
    ...
    /**    
     * Returns item level adjustment for versions of Spark Commerce prior to 2.3.0 which replaced
