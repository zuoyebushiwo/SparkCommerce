...
@Table(name = "SC_CATEGORY_PRODUCT_XREF")
...
public class CategoryProductXrefImpl implements CategoryProductXref {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.catalog.domain.CategoryProductXrefImpl")
        }
    )
