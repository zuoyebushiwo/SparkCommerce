...
@Table(name = "SC_ORDER_ITEM_ADJUSTMENT")
...
public class OrderItemAdjustmentImpl implements OrderItemAdjustment, CurrencyCodeIdentifiable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.OrderItemAdjustmentImpl")
        }
    )
    ...
    public Money getValue() {
        return value == null ? null : SparkCurrencyUtils.getMoney(value, getOrderItem().getOrder().getCurrency());
    }
    ...
    public Money getRetailPriceValue() {
        if (retailValue == null) {
            return SparkCurrencyUtils.getMoney(BigDecimal.ZERO, getOrderItem().getOrder().getCurrency());
        }
