...
public class TaxDetailImpl implements TaxDetail {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.catalog.domain.TaxDetailImpl")
        }
    )
    ...
    public Money getAmount() {
        return SparkCurrencyUtils.getMoney(amount, currency);
    }
