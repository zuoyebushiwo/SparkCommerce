...
@Entity
@Table(name = "SC_CANDIDATE_ORDER_OFFER")
...
public class CandidateOrderOfferImpl implements CandidateOrderOffer {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.CandidateOrderOfferImpl")
        }
    )
    ...
    public Money getDiscountedPrice() {
        return discountedPrice == null ? null : SparkCurrencyUtils.getMoney(discountedPrice, getOrder().getCurrency());
    }
