 ...
 * #L%
 */
package org.sparkcommerce.admin.web.rulebuilder;
...
import org.sparkcommerce.admin.web.rulebuilder.service.CustomerFieldServiceImpl;
import org.sparkcommerce.admin.web.rulebuilder.service.FulfillmentGroupFieldServiceImpl;
import org.sparkcommerce.admin.web.rulebuilder.service.OrderFieldServiceImpl;
import org.sparkcommerce.admin.web.rulebuilder.service.OrderItemFieldServiceImpl;
...
public class MVELToDataWrapperTranslatorTest extends TestCase {
    ...
    public void testCreateRuleData() throws MVELTranslationException {
        ...
        assert(exp.getOperator().equals(SCOperator.IEQUALS.name()));
    ...
    public void testCustomerQualificationDataWrapper() throws MVELTranslationException {
        ...
        assert(dataWrapper.getData().get(0).getGroupOperator().equals(SCOperator.AND.name()));
        ...
        assert(e1.getOperator().equals(SCOperator.NOT_EQUAL_FIELD.name()));
        ...
        assert(e2.getOperator().equals(SCOperator.EQUALS.name()));
    ...
    public void testOrderQualificationDataWrapper() throws MVELTranslationException {
        ...
        assert(e1.getOperator().equals(SCOperator.GREATER_OR_EQUAL.name()));
        ...
        assert(d1.getGroupOperator().equals(SCOperator.OR.name()));
        ...
        assert(d1e1.getOperator().equals(SCOperator.EQUALS.name()));
        ...
        assert(d1e2.getOperator().equals(SCOperator.EQUALS.name()));
    ...
    public void testItemQualificationDataWrapper() throws MVELTranslationException {
        ...
        assert(exp1.getOperator().equals(SCOperator.EQUALS.name()));
        assert(exp1.getValue().equals("test category"));

        assert(dataWrapper.getData().get(1).getQuantity() == 2);
        assert(dataWrapper.getData().get(1).getGroupOperator().equals(SCOperator.NOT.name()));
        ...
        assert(expd1e1.getOperator().equals(SCOperator.EQUALS.name()));
        ...
        assert(expd1e2.getOperator().equals(SCOperator.EQUALS.name()));
    ...
    public void testFulfillmentGroupQualificationDataWrapper() throws MVELTranslationException {
        ...
        assert(e1.getOperator().equals(SCOperator.EQUALS.name()));
        assert(e1.getValue().equals("Texas"));

        assert(dataWrapper.getData().get(0).getGroups().get(1) instanceof ExpressionDTO);
        ExpressionDTO e2 = (ExpressionDTO) dataWrapper.getData().get(0).getGroups().get(1);
        assert(e2.getName().equals("retailFulfillmentPrice"));
        assert(e2.getOperator().equals(SCOperator.BETWEEN_INCLUSIVE.name()));
