 ...
 * #L%
 */
package org.sparkcommerce.admin.web.controller.entity;
...
import org.sparkcommerce.openadmin.web.controller.entity.AdminBasicEntityController;
import org.sparkcommerce.openadmin.web.form.component.ListGrid;
import org.sparkcommerce.openadmin.web.form.component.ListGridAction;
...
import org.sparkcommerce.admin.server.service.handler.ProductCustomPersistenceHandler;
...
public class AdminProductController extends AdminBasicEntityController {
    ...
    protected String showUpdateAdditionalSku(HttpServletRequest request, HttpServletResponse response, Model model,
        ...
        for (ListGrid lg : entityForm.getAllListGrids()) {
            lg.setSectionKey("org.sparkcommerce.core.catalog.domain.Sku");
