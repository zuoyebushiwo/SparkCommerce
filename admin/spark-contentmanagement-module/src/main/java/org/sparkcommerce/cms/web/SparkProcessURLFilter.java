...
import org.sparkcommerce.common.time.FixedTimeSource;
import org.sparkcommerce.common.time.SystemTime;
import org.sparkcommerce.common.web.SparkRequestContext;
import org.sparkcommerce.common.web.util.StatusExposingServletResponse;
...
/**
 * @deprecated In favor of org.sparkcommerce.common.web.SparkRequestFilter.
 ...
 */
@Deprecated
public class SparkProcessURLFilter extends OncePerRequestFilter {
    private final Log LOG = LogFactory.getLog(SparkProcessURLFilter.class);
    ...
    public void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            if (urlProcessor instanceof NullURLProcessor) {
                ...
                if (LOG.isTraceEnabled()) {
                    LOG.trace("URL not being processed by a Spark URLProcessor " + requestURIWithoutContext);
                }
                ...
                if (LOG.isTraceEnabled()) {
                    LOG.trace("URL about to be processed by a Spark URLProcessor " + requestURIWithoutContext);
                }                
     ...
     * <p/>
     * By default, this method returns false for any SC-Admin URLs and service calls and for all
    ...
    protected boolean shouldProcessURL(HttpServletRequest request, String requestURI) {
        if (requestURI.contains(SC_ADMIN_GWT) || 
            requestURI.endsWith(SC_ADMIN_SERVICE) ||
            requestURI.contains(SC_ADMIN_PREFIX)) {
            if (LOG.isTraceEnabled()) {
