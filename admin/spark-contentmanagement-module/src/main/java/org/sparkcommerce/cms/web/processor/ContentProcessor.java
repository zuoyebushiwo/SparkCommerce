 ...
 * #L%
 */
package org.sparkcommerce.cms.web.processor;
...
import org.sparkcommerce.cms.web.deeplink.ContentDeepLinkServiceImpl;
...
/**
 * Processor used to display structured content that is maintained with the Spark CMS.
 *
...
public class ContentProcessor extends AbstractModelVariableModifierProcessor {
    ...
    protected Map<String, Object> buildMvelParameters(HttpServletRequest request, Arguments arguments, Element element) {
        TimeZone timeZone = SparkRequestContext.getSparkRequestContext().getTimeZone();
