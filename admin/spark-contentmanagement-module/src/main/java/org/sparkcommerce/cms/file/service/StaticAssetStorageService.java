...
public interface StaticAssetStorageService {
     ...
     * 
     * Storing Assets in the DB is not the preferred mechanism for Spark as of 3.0 so in most cases, this 
     * method would not be used by Spark implementations.
     * 
     * @param id
     * @return
     */
    ...
    /**
     * Persists a static asset to the database.   Not typically used since Spark 3.0 as the 
    ...
    /**
     * Removes a static asset from the database.   Not typically used since Spark 3.0 as the 
     * preferred method for storing assets is on a shared-filesystem.
     * 
     * @param assetStorage
     */
