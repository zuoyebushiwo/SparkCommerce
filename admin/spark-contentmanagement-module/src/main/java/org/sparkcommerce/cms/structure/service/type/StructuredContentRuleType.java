 ...
 * #L%
 */
package org.sparkcommerce.cms.structure.service.type;
 ...
 * TIME - indicates a rule based on {@link org.sparkcommerce.common.TimeDTO time}<br>
 * PRODUCT - indicates a rule based on {@link org.sparkcommerce.core.catalog.domain.Product product}
 * CUSTOMER - indicates a rule based on {@link org.sparkcommerce.profile.core.domain}
 */
public class StructuredContentRuleType implements Serializable, SparkEnumerationType {
