 ...
 */
@Entity
@Table(name = "SC_SC_ITEM_CRITERIA")
...
public class StructuredContentItemCriteriaImpl implements StructuredContentItemCriteria {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.cms.page.domain.StructuredContentItemCriteriaImpl")
        }
    )
    ...
    @JoinTable(name = "SC_QUAL_CRIT_SC_XREF", joinColumns = @JoinColumn(name = "SC_ITEM_CRITERIA_ID"), inverseJoinColumns = @JoinColumn(name = "SC_ID"))
    protected StructuredContent structuredContent;

    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.StructuredContentItemCriteria#getId()
     */
    @Override
    public Long getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.StructuredContentItemCriteria#setId(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.StructuredContentItemCriteria#getReceiveQuantity()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.StructuredContentItemCriteria#setReceiveQuantity(java.lang.Integer)
     */
    @Override
