 ...
 */
@Entity
@Table(name = "SC_PAGE_ITEM_CRITERIA")
...
public class PageItemCriteriaImpl implements PageItemCriteria {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.cms.page.domain.PageItemCriteriaImpl")
        }
    )
    ...
    @JoinTable(name = "SC_QUAL_CRIT_PAGE_XREF", joinColumns = @JoinColumn(name = "PAGE_ITEM_CRITERIA_ID"), inverseJoinColumns = @JoinColumn(name = "PAGE_ID"))
    protected Page page;
