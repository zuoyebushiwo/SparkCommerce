 ...
 * #L%
 */
package org.sparkcommerce.cms.file.service;
...
import org.sparkcommerce.cms.common.AssetNotFoundException;
import org.sparkcommerce.cms.field.type.StorageType;
import org.sparkcommerce.cms.file.dao.StaticAssetStorageDao;
import org.sparkcommerce.cms.file.domain.StaticAsset;
import org.sparkcommerce.cms.file.domain.StaticAssetStorage;
import org.sparkcommerce.cms.file.service.operation.NamedOperationManager;
import org.sparkcommerce.common.file.domain.FileWorkArea;
import org.sparkcommerce.common.file.service.SparkFileService;
import org.sparkcommerce.common.file.service.GloballySharedInputStream;
import org.sparkcommerce.openadmin.server.service.artifact.ArtifactService;
...
public class StaticAssetStorageServiceImpl implements StaticAssetStorageService {
    ...
    protected File getFileFromLocalRepository(String cachedFileName) {
        ...
        File cacheFile = sparkFileService.getSharedLocalResource(cachedFileName);
        if (cacheFile.exists()) {
            return cacheFile;
        } else {
            return sparkFileService.getLocalResource(cachedFileName);
        }
    }
    ...
    protected File lookupAssetAndCreateLocalFile(StaticAsset staticAsset, File baseLocalFile)
        ...
        if (StorageType.FILESYSTEM.equals(staticAsset.getStorageType())) {
            File returnFile = sparkFileService.getResource(staticAsset.getFullUrl());
            ...
            return sparkFileService.getResource(staticAsset.getFullUrl());            
        } else {
    ...
    protected void createLocalFileFromClassPathResource(StaticAsset staticAsset, File baseLocalFile) throws IOException {
        InputStream is = sparkFileService.getClasspathResource(staticAsset.getFullUrl());
        createLocalFileFromInputStream(is, baseLocalFile);
    }
