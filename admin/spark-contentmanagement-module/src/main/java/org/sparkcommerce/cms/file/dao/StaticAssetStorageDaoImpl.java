 ...
 * #L%
 */
package org.sparkcommerce.cms.file.dao;

import org.sparkcommerce.cms.file.domain.StaticAssetStorage;
import org.sparkcommerce.cms.file.domain.StaticAssetStorageImpl;
...
public class StaticAssetStorageDaoImpl implements StaticAssetStorageDao {
    ...
    public StaticAssetStorage create() {
        return (StaticAssetStorage) entityConfiguration.createEntityInstance("org.sparkcommerce.cms.file.domain.StaticAssetStorage");
    }
