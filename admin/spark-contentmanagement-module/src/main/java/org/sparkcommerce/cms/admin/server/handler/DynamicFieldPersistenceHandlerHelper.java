    ...
    public Property[] buildDynamicPropertyList(List<FieldGroup> fieldGroups, Class<?> inheritedType) {
        ...
        for (FieldGroup group : fieldGroups) {
            ...
            for (FieldDefinition definition : definitions) {
                ...
                fieldMetadata.setSparkEnumeration("");
                ...
                if (definition.getValidationRegEx() != null) {
                    ...
                    fieldMetadata.getValidationConfigurations().put("org.sparkcommerce.openadmin.server.service.persistence.validation.RegexPropertyValidator", itemMap);
                }
