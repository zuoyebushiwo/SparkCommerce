...
public class StructuredContentRuleImpl implements StructuredContentRule {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.core.offer.domain.StructuredContentRuleImpl")
        }
    )
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.StructuredContentRule#getId()
     */
    @Override
    public Long getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.StructuredContentRule#setId(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.StructuredContentRule#getMatchRule()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.sparkcommerce.core.offer.domain.StructuredContentRule#setMatchRule(java.lang.String)
     */
    @Override
