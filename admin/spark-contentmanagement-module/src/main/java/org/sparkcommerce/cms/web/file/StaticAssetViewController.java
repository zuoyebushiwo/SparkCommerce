 ...
 * #L%
 */
package org.sparkcommerce.cms.web.file;

import org.apache.commons.lang.StringUtils;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.sparkcommerce.cms.common.AssetNotFoundException;
import org.sparkcommerce.cms.file.service.StaticAssetStorageService;
import org.sparkcommerce.cms.file.service.operation.NamedOperationComponent;
import org.sparkcommerce.cms.file.service.operation.NamedOperationManager;
import org.sparkcommerce.cms.file.service.operation.StaticMapNamedOperationComponent;
...
public class StaticAssetViewController extends AbstractController {
    ...
    protected void init() {
        if (getAllowUnnamedImageManipulation()) {
            LOG.warn("Allowing image manipulation strictly through URL parameters that the application does not know about"
                    ...
                    + " default to false starting with Spark 3.2.0-GA. For more information"
                    + " see the docs at http://www.sparkcommerce.com/docs/core/current/spark-concepts/additional-configuration/asset-server-configuration");
        }
    }
    ...
    public boolean getAllowUnnamedImageManipulation() {
        boolean allowUnnamedImageManipulation = 
                SCSystemProperty.resolveBooleanSystemProperty("asset.server.allow.unnamed.image.manipulation");
