...
import org.sparkcommerce.cms.page.domain.PageImpl;
import org.sparkcommerce.cms.page.service.PageSiteMapGenerator;
import org.sparkcommerce.common.sitemap.domain.SiteMapGeneratorConfiguration;
import org.sparkcommerce.common.sitemap.domain.SiteMapGeneratorConfigurationImpl;
import org.sparkcommerce.common.sitemap.exception.SiteMapException;
import org.sparkcommerce.common.sitemap.service.SiteMapGeneratorTest;
...
public class PageSiteMapGeneratorTest extends SiteMapGeneratorTest {
    ...
    public void testPageSiteMapGenerator() throws SiteMapException, IOException {
        ...
        compareFiles(file1, "src/test/resources/org/sparkcommerce/sitemap/page/sitemap_index.xml");
        compareFiles(file2, "src/test/resources/org/sparkcommerce/sitemap/page/sitemap1.xml");
        compareFiles(file3, "src/test/resources/org/sparkcommerce/sitemap/page/sitemap2.xml");
