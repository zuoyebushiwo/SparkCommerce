...
import org.sparkcommerce.common.security.handler.CsrfFilter;
import org.sparkcommerce.openadmin.security.SparkAdminAuthenticationFailureHandler;
 ...
 * 
 * The "blCsrfFilter' from applicationContext-admin-security should reference this class (org.sparkcommerce.openadmin.web.filter.AdminCsrfFilter)
 * instead of the CsrfFilter
 * 
 *     <bean id="blCsrfFilter" class="org.sparkcommerce.openadmin.web.filter.AdminCsrfFilter" />
 *     
...
public class AdminCsrfFilter extends CsrfFilter {
    ...
    SparkAdminAuthenticationFailureHandler failureHandler;
