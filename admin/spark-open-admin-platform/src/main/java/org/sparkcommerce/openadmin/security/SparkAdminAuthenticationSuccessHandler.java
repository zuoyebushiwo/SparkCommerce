 ...
 * @author Jeff Fischer
 */
public class SparkAdminAuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        if (user != null && user.getLastUsedSandBoxId() != null) {
            request.getSession(false).setAttribute(SparkSandBoxResolver.SANDBOX_ID_VAR, user.getLastUsedSandBoxId());
        }
