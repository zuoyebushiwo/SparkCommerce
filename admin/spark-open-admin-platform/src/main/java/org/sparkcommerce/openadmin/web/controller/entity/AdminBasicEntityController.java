 ...
 * #L%
 */
package org.sparkcommerce.openadmin.web.controller.entity;
...
import org.sparkcommerce.common.util.SCArrayUtils;
...
import org.sparkcommerce.openadmin.web.controller.AdminAbstractController;
import org.sparkcommerce.openadmin.web.editor.NonNullBooleanEditor;
...
import org.sparkcommerce.openadmin.web.form.entity.DefaultMainActions;
import org.sparkcommerce.openadmin.web.form.entity.EntityForm;
import org.sparkcommerce.openadmin.web.form.entity.EntityFormAction;
...
/**
 * The default implementation of the {@link #SparkAdminAbstractEntityController}. This delegates every call to 
...
public class AdminBasicEntityController extends AdminAbstractController {
    ...
    public @ResponseBody Map<String, String> getCollectionValueDetails(HttpServletRequest request, HttpServletResponse response, Model model,
        ...
        if (md instanceof BasicFieldMetadata) {
            ...
            List<String> filterValues = SCArrayUtils.asList(ids.split(FILTER_VALUE_SEPARATOR_REGEX));
