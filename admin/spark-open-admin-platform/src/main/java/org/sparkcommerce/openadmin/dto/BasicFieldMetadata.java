...
import org.sparkcommerce.openadmin.dto.visitor.MetadataVisitor;
...
public class BasicFieldMetadata extends FieldMetadata {
    ...
    protected String sparkEnumeration;
    ...
    public String getSparkEnumeration() {
        return sparkEnumeration;
    }

    public void setSparkEnumeration(String sparkEnumeration) {
        this.sparkEnumeration = sparkEnumeration;
    }
    ...
    public FieldMetadata cloneFieldMetadata() {
        ...
        metadata.sparkEnumeration = sparkEnumeration;
    ...
    public boolean equals(Object o) {
        ...
        if (sparkEnumeration != null ? !sparkEnumeration.equals(metadata.sparkEnumeration) : metadata.sparkEnumeration != null) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (sparkEnumeration != null ? sparkEnumeration.hashCode() : 0);
