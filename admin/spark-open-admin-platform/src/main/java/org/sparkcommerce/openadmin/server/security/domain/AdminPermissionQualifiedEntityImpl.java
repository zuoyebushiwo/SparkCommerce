...
@Table(name = "SC_ADMIN_PERMISSION_ENTITY")
...
public class AdminPermissionQualifiedEntityImpl implements AdminPermissionQualifiedEntity, Serializable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="org.sparkcommerce.openadmin.server.security.domain.AdminPermissionQualifiedEntityImpl")
        }
    )
    ...
    public void checkCloneable(AdminPermissionQualifiedEntity qualifiedEntity) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("org.sparkcommerce") && !qualifiedEntity.getClass().getName().startsWith("org.sparkcommerce")) {
