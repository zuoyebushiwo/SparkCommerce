 ...
 * %%
 * Copyright (C) 2009 - 2015 Spark Commerce
 * %%
 ...
 * #L%
 */
package org.sparkcommerce.openadmin.server.security.ldap;
...
import org.sparkcommerce.openadmin.server.security.domain.AdminUserImpl;
import org.sparkcommerce.openadmin.server.security.service.AdminSecurityService;
import org.sparkcommerce.openadmin.server.security.service.AdminUserDetails;
 ...
 *
 */
public class SparkAdminLdapUserDetailsMapper extends LdapUserDetailsMapper {
    ...
    protected AdminUser saveAdminUserAndSecurityData(AdminUser adminUser, Set<AdminRole> adminRoles) {
        //We have to do this because SC replies on the role relationships being stored in the DB
