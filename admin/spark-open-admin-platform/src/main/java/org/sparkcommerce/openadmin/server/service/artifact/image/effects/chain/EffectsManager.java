 ...
 * #L%
 */
package org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain;

import org.sparkcommerce.openadmin.server.service.artifact.OperationBuilder;
import org.sparkcommerce.openadmin.server.service.artifact.image.Operation;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.conversion.ConversionManager;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.conversion.Parameter;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.filter.AlterHSB;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.filter.AlterRGB;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.filter.AutoLevelsRGB;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.filter.Crop;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.filter.FilterTypeEnum;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.filter.GaussianBlur;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.filter.Resize;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.filter.Rotate;
import org.sparkcommerce.openadmin.server.service.artifact.image.effects.chain.filter.UnsharpMask;
