...
public class SparkAdminAuthenticationFailureHandler extends SimpleUrlAuthenticationFailureHandler {

    private String defaultFailureUrl;

    public SparkAdminAuthenticationFailureHandler() {
        super();
    }

    public SparkAdminAuthenticationFailureHandler(String defaultFailureUrl) {
