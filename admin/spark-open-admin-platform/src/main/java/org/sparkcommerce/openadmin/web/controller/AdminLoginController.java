...
import org.sparkcommerce.openadmin.web.form.ResetPasswordForm;
...
/**
 * AdminLoginController handles login related needs for the SC admin including:
 * <ul>
...
public class AdminLoginController extends SparkAbstractController {
