...
/**
 * Interface for handling various lifecycle event for the {@link org.sparkcommerce.openadmin.server.service.persistence.PersistenceManager}.
...
public interface PersistenceManagerEventHandler extends Ordered {
     ...
     * {@link org.sparkcommerce.openadmin.dto.Entity#getPropertyValidationErrors()}
     *
     * @param persistenceManager the PersistenceManager instance making the call
