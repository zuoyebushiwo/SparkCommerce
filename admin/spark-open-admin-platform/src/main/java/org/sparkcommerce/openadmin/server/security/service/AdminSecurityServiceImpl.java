 ...
 * #L%
 */
package org.sparkcommerce.openadmin.server.security.service;
...
import org.sparkcommerce.common.security.util.PasswordUtils;
import org.sparkcommerce.common.service.GenericResponse;
import org.sparkcommerce.common.time.SystemTime;
import org.sparkcommerce.common.util.SCSystemProperty;
import org.sparkcommerce.openadmin.server.security.dao.AdminPermissionDao;
import org.sparkcommerce.openadmin.server.security.dao.AdminRoleDao;
import org.sparkcommerce.openadmin.server.security.dao.AdminUserDao;
import org.sparkcommerce.openadmin.server.security.dao.ForgotPasswordSecurityTokenDao;
...
import org.sparkcommerce.openadmin.server.security.domain.ForgotPasswordSecurityToken;
import org.sparkcommerce.openadmin.server.security.domain.ForgotPasswordSecurityTokenImpl;
...
public class AdminSecurityServiceImpl implements AdminSecurityService {
    ...
    protected int getTokenExpiredMinutes() {
        return SCSystemProperty.resolveIntSystemProperty("tokenExpiredMinutes");
    }    

    protected String getResetPasswordURL() {
        return SCSystemProperty.resolveSystemProperty("resetPasswordURL");
    }
