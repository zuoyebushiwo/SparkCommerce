 ...
 * #L%
 */
package org.sparkcommerce.openadmin.server.security.dao;
...
public class AdminPermissionDaoImpl implements AdminPermissionDao {
    ...
    public AdminPermission readAdminPermissionById(Long id) {
        return (AdminPermission) em.find(entityConfiguration.lookupEntityClass("org.sparkcommerce.openadmin.server.security.domain.AdminPermission"), id);
    }
