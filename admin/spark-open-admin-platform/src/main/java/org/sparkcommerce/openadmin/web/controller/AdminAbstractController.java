...
import org.sparkcommerce.common.util.SCMapUtils;
import org.sparkcommerce.common.util.TypedClosure;
...
import org.sparkcommerce.openadmin.dto.ClassTree;
...
import org.sparkcommerce.openadmin.web.form.entity.EntityFormValidator;
import org.sparkcommerce.openadmin.web.form.entity.Field;
import org.sparkcommerce.openadmin.web.form.entity.FieldGroup;
import org.sparkcommerce.openadmin.web.form.entity.Tab;
import org.sparkcommerce.openadmin.web.service.FormBuilderService;
 ...
 *
 * @see org.sparkcommerce.openadmin.web.handler.AdminNavigationHandlerMapping
 * @author elbertbautista
 * @author apazzolini
 */
public abstract class AdminAbstractController extends SparkAbstractController {
    ...
    /**
     * <p>Helper method to return an array of {@link org.sparkcommerce.openadmin.dto.FilterAndSortCriteria} based on a map of propertyName -> list of criteria
     ...
     * @return the final array of {@link org.sparkcommerce.openadmin.dto.FilterAndSortCriteria} to pass to the fetch
     * 
    ...
    protected FilterAndSortCriteria[] getCriteria(Map<String, List<String>> requestParams) {
        ...
        if (CollectionUtils.isNotEmpty(sortProperties)) {
            ...
            Map<String, FilterAndSortCriteria> fasMap = SCMapUtils.keyedMap(result, new TypedClosure<String, FilterAndSortCriteria>() {
