...
import org.sparkcommerce.common.presentation.client.UnspecifiedBooleanType;
import org.sparkcommerce.common.presentation.override.AdminPresentationMapOverride;
...
public class MapFieldMetadataProvider extends AdvancedCollectionFieldMetadataProvider {
    ...
    protected void buildMapMetadata(Class<?> parentClass, Class<?> targetClass, Map<String, FieldMetadata> attributes,
        ...
        org.sparkcommerce.openadmin.dto.OperationTypes dtoOperationTypes = new org.sparkcommerce.openadmin.dto.OperationTypes(OperationType.MAP, OperationType.MAP, OperationType.MAP, OperationType.MAP, OperationType.MAP);
