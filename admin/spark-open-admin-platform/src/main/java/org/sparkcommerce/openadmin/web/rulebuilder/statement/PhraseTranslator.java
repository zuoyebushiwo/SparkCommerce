 ...
 * #L%
 */
package org.sparkcommerce.openadmin.web.rulebuilder.statement;
...
import org.sparkcommerce.openadmin.web.rulebuilder.RuleBuilderFormatUtil;
...
public class PhraseTranslator {
    ...
    public Expression createExpression(String phrase) throws MVELTranslationException {
        ...
        SCOperator operatorId = getOperator(field, operator, value, isNegation, isFieldComparison, isIgnoreCase);
    ...
    protected SCOperator getOperator(String field, String operator, String value, boolean isNegation,
                                     boolean isFieldComparison, boolean isIgnoreCase) throws MVELTranslationException {
        if (operator.equals("==") && value.equals("null")) {
            return SCOperator.IS_NULL;
        } else if (operator.equals("==") && isFieldComparison) {
            return SCOperator.EQUALS_FIELD;
        } else if (
                isIgnoreCase &&
                        operator.equals("==")
                ) {
            return SCOperator.IEQUALS;
        } else if (operator.equals("==")) {
            return SCOperator.EQUALS;
        } else if (operator.equals("!=") && value.equals("null")) {
            return SCOperator.NOT_NULL;
        } else if (operator.equals("!=") && isFieldComparison) {
            return SCOperator.NOT_EQUAL_FIELD;
        } else if (
                isIgnoreCase &&
                        operator.equals("!=")
                ) {
            return SCOperator.INOT_EQUAL;
        } else if (operator.equals("!=")) {
            return SCOperator.NOT_EQUAL;
        } else if (operator.equals(">") && isFieldComparison) {
            return SCOperator.GREATER_THAN_FIELD;
        } else if (operator.equals(">")) {
            return SCOperator.GREATER_THAN;
        } else if (operator.equals("<") && isFieldComparison) {
            return SCOperator.LESS_THAN_FIELD;
        } else if (operator.equals("<")) {
            return SCOperator.LESS_THAN;
        } else if (operator.equals(">=") && isFieldComparison) {
            return SCOperator.GREATER_OR_EQUAL_FIELD;
        } else if (operator.equals(">=")) {
            return SCOperator.GREATER_OR_EQUAL;
        } else if (operator.equals("<=") && isFieldComparison) {
            return SCOperator.LESS_OR_EQUAL_FIELD;
        } else if (operator.equals("<=")) {
            return SCOperator.LESS_OR_EQUAL;
        } else if (
                isIgnoreCase &&
                        operator.equals("contains") &&
                        isNegation
                ) {
            return SCOperator.INOT_CONTAINS;
        } else if (operator.equals("contains") && isNegation) {
            return SCOperator.NOT_CONTAINS;
        } else if (
                isIgnoreCase &&
                        operator.equals("contains")
                ) {
            return SCOperator.ICONTAINS;
        } else if (operator.equals("contains") && isFieldComparison) {
            return SCOperator.CONTAINS_FIELD;
        } else if (operator.equals("contains")) {
            return SCOperator.CONTAINS;
        } else if (
                isIgnoreCase &&
                        operator.equals("startsWith") &&
                        isNegation
                ) {
            return SCOperator.INOT_STARTS_WITH;
        } else if (operator.equals("startsWith") && isNegation) {
            return SCOperator.NOT_STARTS_WITH;
        } else if (
                isIgnoreCase &&
                        operator.equals("startsWith")
                ) {
            return SCOperator.ISTARTS_WITH;
        } else if (operator.equals("startsWith") && isFieldComparison) {
            return SCOperator.STARTS_WITH_FIELD;
        } else if (operator.equals("startsWith")) {
            return SCOperator.STARTS_WITH;
        } else if (
                isIgnoreCase &&
                        operator.equals("endsWith") &&
                        isNegation
                ) {
            return SCOperator.INOT_ENDS_WITH;
        } else if (operator.equals("endsWith") && isNegation) {
            return SCOperator.NOT_ENDS_WITH;
        } else if (
                isIgnoreCase &&
                        operator.equals("endsWith")
                ) {
            return SCOperator.IENDS_WITH;
        } else if (operator.equals("endsWith") && isFieldComparison) {
            return SCOperator.ENDS_WITH_FIELD;
        } else if (operator.equals("endsWith")) {
            return SCOperator.ENDS_WITH;
        } else if (operator.equals(".size()>")) {
            return SCOperator.COUNT_GREATER_THAN;
        } else if (operator.equals(".size()>=")) {
            return SCOperator.COUNT_GREATER_OR_EQUAL;
        } else if (operator.equals(".size()<")) {
            return SCOperator.COUNT_LESS_THAN;
        } else if (operator.equals(".size()<=")) {
            return SCOperator.COUNT_LESS_OR_EQUAL;
        } else if (operator.equals(".size()==")) {
            return SCOperator.COUNT_EQUALS;
        }
