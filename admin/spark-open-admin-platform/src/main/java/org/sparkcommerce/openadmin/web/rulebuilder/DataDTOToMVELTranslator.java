 ...
 * #L%
 */
package org.sparkcommerce.openadmin.web.rulebuilder;
...
import org.sparkcommerce.openadmin.web.rulebuilder.dto.ExpressionDTO;
import org.sparkcommerce.openadmin.web.rulebuilder.service.RuleBuilderFieldService;
...
public class DataDTOToMVELTranslator {
    ...
    protected void buildMVEL(DataDTO dataDTO, StringBuffer sb, String entityKey, String groupOperator,
        ...
        if (dataDTO instanceof ExpressionDTO) {
            ...
            if (sb.length() != 0 || SCOperator.NOT.equals(operator) || (sb.length() == 0 && groupOperator != null)) {
    ...
    protected void buildExpression(ExpressionDTO expressionDTO, StringBuffer sb, String entityKey,
            SCOperator operator, RuleBuilderFieldService fieldService)
            throws MVELTranslationException {
        ...
        if (
            SupportedFieldType.DATE.toString().equals(type.toString()) &&
                !SCOperator.CONTAINS_FIELD.equals(operator) &&
                !SCOperator.ENDS_WITH_FIELD.equals(operator) &&
                !SCOperator.EQUALS_FIELD.equals(operator) &&
                !SCOperator.GREATER_OR_EQUAL_FIELD.equals(operator) &&
                !SCOperator.GREATER_THAN_FIELD.equals(operator) &&
                !SCOperator.LESS_OR_EQUAL_FIELD.equals(operator) &&
                !SCOperator.LESS_THAN_FIELD.equals(operator) &&
                !SCOperator.NOT_EQUAL_FIELD.equals(operator) &&
                !SCOperator.STARTS_WITH_FIELD.equals(operator) &&
                !SCOperator.BETWEEN.equals(operator) &&
                !SCOperator.BETWEEN_INCLUSIVE.equals(operator)
            ) {
        ...
        switch(operator) {
            ...
            case BETWEEN: {
                if (SupportedFieldType.DATE.toString().equals(type.toString())) {
                    sb.append("(");
                    buildExpression(sb, entityKey, field, extractDate(expressionDTO, SCOperator.GREATER_THAN, "start"),
                            type, secondaryType, ">", false, false, false, false, false);
                    sb.append("&&");
                    buildExpression(sb, entityKey, field, extractDate(expressionDTO, SCOperator.LESS_THAN, "end"),
                            type, secondaryType, "<", false, false, false, false, false);
                    sb.append(")");
                } else {
                    sb.append("(");
            ...
            case BETWEEN_INCLUSIVE: {
                if (
                    ...
                    buildExpression(sb, entityKey, field,
                            extractDate(expressionDTO, SCOperator.GREATER_OR_EQUAL, "start"), type,
                            secondaryType, ">=", false, false, false, false, false);
                    sb.append("&&");
                    buildExpression(sb, entityKey, field, extractDate(expressionDTO, SCOperator.LESS_OR_EQUAL, "end"),
                            type, secondaryType, "<=", false, false, false, false, false);
                    sb.append(")");
                } else {
                    sb.append("(");
    ...
    protected Object[] extractDate(ExpressionDTO expressionDTO, SCOperator operator, String key) {
        String value;
...
//        if (SCOperator.GREATER_THAN.equals(operator) || SCOperator.LESS_OR_EQUAL.equals(operator)) {
