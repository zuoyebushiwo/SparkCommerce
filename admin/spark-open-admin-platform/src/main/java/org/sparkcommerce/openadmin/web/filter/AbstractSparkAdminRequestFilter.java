 ...
 * @author Jeff Fischer
 */
public abstract class AbstractSparkAdminRequestFilter extends OncePerRequestFilter {

    private final Log LOG = LogFactory.getLog(AbstractSparkAdminRequestFilter.class);
