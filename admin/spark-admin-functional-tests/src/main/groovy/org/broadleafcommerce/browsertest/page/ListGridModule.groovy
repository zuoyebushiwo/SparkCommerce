 ...
 * #L%
 */
package org.sparkcommerce.browsertest.page
...
class ListGridModule extends Module {
    ...
    def scrollToIndex(int number) {
        if (id == null || id.isEmpty()) {
            js.exec 'SCAdmin.listGrid.paginate.scrollToIndex($(\'.listgrid-body-wrapper tbody\'), ' + number + ');'
        } else {
            js.exec 'SCAdmin.listGrid.paginate.scrollToIndex($(\'.' + id + ' .listgrid-body-wrapper tbody\'), ' + number + ');'
        }
    }
